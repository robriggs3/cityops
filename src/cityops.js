var CityOps = (function () {
  ...
  function interestsBlockLines(p) {
    var b = ['## Traveler interests', '',
      'Add a ninth section for these interests as described under Interests below.', ''];
  ...
  function buildCityPrompt(templateText, header, profile) {
    ...
    if (!profileIsEmpty(p)) out = insertInterestsBlock(out, interestsBlockLines(p));
    return out.join('\n');
  }
