var CityOps = (function () {
  ...
  // ones ahead of you in date order. With Rob's data on 2026-08-27 (in Tirana
  // until the 29th, Tirana's guide removed, Ksamil ahead) that lands on
  // Ksamil, which is the guide he would actually want open.
