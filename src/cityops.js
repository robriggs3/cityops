var CityOps = (function () {
  ...
  function itemBody(it, status, showWhen, withDayPicker) {
    ...
    h3.appendChild(document.createTextNode(effectiveName(it, curState)));
  ...
  function renderShare() {
    ...
    sm.days.forEach(function (d) {
      ...
      d.entries.forEach(function (e) {
        ...
        h3.appendChild(document.createTextNode(effectiveName(e.it, state)));
